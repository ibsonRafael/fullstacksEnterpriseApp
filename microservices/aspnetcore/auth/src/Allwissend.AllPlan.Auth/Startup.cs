...
using Allwissend.AllPlan.Auth.Filters;
            ...
            services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme)
                .AddJwtBearer(options =>
                {
                    options.TokenValidationParameters = new TokenValidationParameters
                    {
                        ...
                        ValidIssuer = Configuration["JwtTokenConfigurations:Issuer"],
                        ValidAudience = Configuration["JwtTokenConfigurations:Issuer"],
            ...
            services
                .AddSwaggerGen(c =>
                {
                    c.SwaggerDoc("1.0.0", new Info
                    {
                        ...
                        Description = "Allwissend Microservices API (ASP.NET Core 2.0)",
                        Contact = new Contact()
                        {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app
                ...
                .UseSwaggerUI(c =>
                {
                    ...
                    c.SwaggerEndpoint("/swagger/1.0.0/swagger.json", "Allwissend Microservices API");

                    //TODO: Or alternatively use the original Swagger contract that's included in the static files
                    // c.SwaggerEndpoint("/swagger-original.json", "Allwissend Microservices API Original");
                });
